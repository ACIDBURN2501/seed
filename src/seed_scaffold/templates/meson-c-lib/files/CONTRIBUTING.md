...
- Public sources (`src/*.c`, `include/*.h`) carry an
  `SPDX-License-Identifier: MIT` tag in their header comment.
...
- Keep public headers minimal and stable; route compile-time configuration
  through `{{PROJECT_SLUG}}_conf.h`.
